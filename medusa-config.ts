...
if (isStorageConfigured) {
  console.log(' DigitalOcean Spaces (S3) enabled');
  ...
  console.warn('  DO Space vars missing — using local file storage');
}
...
if (isResendConfigured) {
  ...
  console.warn(' Resend vars missing — email notifications disabled');
}
...
module.exports = defineConfig({
  ...
  projectConfig: {
    ...
    // ✅ Redis is required for Medusa 2.x events & job queues
